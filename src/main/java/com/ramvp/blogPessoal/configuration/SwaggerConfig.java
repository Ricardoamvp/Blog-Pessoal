package com.ramvp.blogPessoal.configuration;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                        .basePackage("com.ramvp.blogPessoal.controller"))
    ...
    private static Contact contact() {
        return new Contact("Ricardo Alex",
                "https://github.com/Ricardoamvp",
                "ricardo.amvp@gmail.com");
    }
